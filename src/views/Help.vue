  ...
  <div>
    ...
    <el-card>
      <el-row style="text-align: center">
        <el-col>
          <div class="steps">
            第三步：返回观看页面，粘贴复制的地址，选择解析接口，点击立即播放按钮
          </div>
        </el-col>
        <el-col>
    ...
    <el-card>
      <el-row style="text-align: center">
        <el-col>
          <div class="steps">
            备注2：若出现备注1的情况，则先在视频输入框中输入完整片名，然后点击搜索按钮
          </div>
        </el-col>
        <el-col>
    ...
    <el-card>
      <el-row style="text-align: center">
        <el-col>
          <div class="steps">
            备注4：若出现备注1的情况，最后可点击图示按钮选择对应的集数
          </div>
        </el-col>
        <el-col>
