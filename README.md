...
- v2.5版本输出代码高亮显示，流式处理EventStream，逐字显示在屏幕上，并支持会话存储（2023.5.13-2023.5.14）
- v2.6版本接入文心一言基础服务，增加输出内容的语音朗读功能、生成的每段代码块都增加复制代码按钮（后续安排）
- v2.7版本整体优化代码，修复bug，并抽离封装部分函数和组件，降低复杂度，实现高内聚低耦合（边开发边优化修复中）
